...
@NamedQueries({
    ...
    @NamedQuery(name = "Promotions.findByPromotionType", query = "SELECT p FROM Promotions p WHERE p.promotionType = :promotionType"),
...
public class Promotions implements Serializable {
    ...
    public Promotions(Integer promotionID, String code, String promotionType, Date startDate, Date endDate) {
        this.promotionID = promotionID;
        this.code = code;
